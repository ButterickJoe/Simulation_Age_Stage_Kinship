...
sim_sis_df <- read_rds(here::here("Outputs", "Comparisons", "Time variant", "data frames", "YS_IC7_TV.Rds"))
...
sim_sis_df
df_my_variant <- read_rds(here::here("Outputs", "Comparisons", "Time variant", "data frames", "YS_matrixTV_IC7.Rds"))
df_my_variant
...
plt_out <-  here::here("Outputs","Comparisons","Time variant", "Figures")
fs::dir_create(df_out)
ggsave(plt_comparison, file = paste0(plt_out , "/" , "YS_IC7_TV.png" ), width = 8, height = 5, dpi = 300)
