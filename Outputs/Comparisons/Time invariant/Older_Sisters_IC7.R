...
sim_sis_df <- read_rds(here::here("Outputs", "Comparisons", "Time invariant", "data frames", "OS_TI_IC7_comparison.Rds"))
...
df_my_variant <- read_rds(here::here("Outputs", "Comparisons", "Time invariant", "data frames", "OS_matrix_IC7.Rds"))
